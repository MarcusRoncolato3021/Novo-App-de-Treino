...
export default function Home() {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 min-h-screen font-sans pb-24 homepage-container">
      <div className="home-status-bar absolute top-0 left-0 right-0 h-12 z-10"></div>
      <header className="pt-8 pb-6 px-6 bg-gradient-to-br from-blue-50 to-indigo-50">
