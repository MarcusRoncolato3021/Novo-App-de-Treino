...
function InferioresContent() {
  ...
  // Buscar todos os treinos da categoria inferiores
  const treinos = useLiveQuery(() => 
    db.treinos.where('categoria').equals('inferiores').toArray()
  );
  ...
  // Adicionar novo treino da categoria inferiores
  const adicionarTreino = async () => {
    ...
    try {
      ...
      toast.success('Treino de inferiores adicionado com sucesso!');
    } catch (error) {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 min-h-screen font-sans pb-24">
      <header className="divide-y divide-gray-100">
        <div className="pt-3 pb-2 px-6 bg-gray-50/80 backdrop-blur-sm shadow-sm">
          <div className="flex justify-between items-center relative">
            ...
            <h1 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-green-800 -mt-1">Treinos de Inferiores</h1>
            <button 
              onClick={() => setModalNovoTreinoAberto(true)}
              className="p-2 rounded-full bg-green-100 hover:bg-green-200 text-green-600 transition-all duration-300"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="px-6 py-4 bg-gradient-to-br from-blue-50 to-indigo-50">
          ...
          <div className="relative mb-6">
            ...
            <input
              type="text"
              placeholder="Buscar treinos de inferiores..."
              value={busca}
          ...
          <div className="flex items-center mb-4 bg-white p-3 rounded-xl shadow-sm">
            <label className="flex items-center cursor-pointer">
              <div className={`w-6 h-6 rounded-full flex items-center justify-center mr-3 ${mostrarInativos ? 'bg-green-100' : 'bg-gray-100'}`}>
                <input
                  type="checkbox"
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 text-center">
            <p className="text-gray-600 mb-4">
              {busca.trim() 
                ...
                : mostrarInativos 
                  ? "Nenhum treino de inferiores registrado" 
                  : "Nenhum treino de inferiores ativo. Adicione um novo treino."}
            </p>
            <button
              onClick={() => setModalNovoTreinoAberto(true)}
            ...
            >
              Adicionar treino de inferiores
            </button>
          </div>
        ) : (
          <div className="space-y-4">
      ...
      {modalNovoTreinoAberto && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 w-[90%] max-w-md">
            <h3 className="text-xl font-bold text-gray-900 mb-4">Novo Treino de Inferiores</h3>
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Ex: Treino B - Pernas"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
